...
Public Class ProcesoDeTrabajo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProyectoIHER.ProcesoDeTrabajo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProcesoDeTrabajo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProcesoDeTrabajo = New ProcesoDeTrabajo()
        rpt.Site = Me.Site
        Return rpt
    End Function
