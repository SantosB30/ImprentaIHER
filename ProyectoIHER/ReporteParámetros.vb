...
Public Class ReporteParámetros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProyectoIHER.ReporteParámetros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteParámetros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteParámetros = New ReporteParámetros()
        rpt.Site = Me.Site
        Return rpt
    End Function
