                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-5" id="data_5">
                            ...
                            <input type="text" class="form-control" id="nombreCliente" name="nombreCliente" value="@Session("clienteEditar")" />
                        </div>
                        <div class="col-md-5" id="data_5">
                            <label class="font-normal"><strong>Dirección:</strong></label>
                            <input type="text" class="form-control" id="direccionCliente" name="direccionCliente" value="@Session("direccionClienteEditar")"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Teléfono:</strong></label>
                            <input type="text" class="form-control" id="telefonoCliente" name="telefonoCliente" value="@Session("telefonoClienteEditar")"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Correo electrónico:</strong></label>
                            <input type="email" class="form-control" id="correo" name="correo" maxlength="50" value="@Session("correoClienteEditar")"/>
                        </div>
                        ...
                        <div class="col-md-5" id="data_5">
                            ...
                            <input type="text" placeholder="Nacionalidad..." class="form-control" id="nacionalidad" name="nacionalidad" value="@Session("nacionalidadClienteEditar")"/>
                        </div>
                        <div class="col-md-5">
                            <br>
                            <br>
