                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-5" id="data_5">
                            ...
                            <input type="text" placeholder="Nacionalidad..." class="form-control" id="nacionalidad" name="nacionalidad"/>
                        </div>
                        <div class="col-md-5">
                            <br>
                            <br>
...
<script>
    ...
    /*initiate the autocomplete function on the "nacionalidad" element, and pass along the countries array as possible autocomplete values:*/
