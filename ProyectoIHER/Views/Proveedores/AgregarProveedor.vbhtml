                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-5" id="data_5">
                            ...
                            <input type="email" class="form-control" id="correoProveedor" name="correoProveedor" maxlength="50" required />
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Nombre contacto:</strong></label>
                            <input type="text" class="form-control" id="nombreContactoProveedor" name="nombreContactoProveedor" required />
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Teléfono contacto:</strong></label>
                            <input type="text" class="form-control" id="telefonoContactoProveedor" name="telefonoContactoProveedor" required />
                        </div>
                        <div class="col-md-5">
                            <br>
                            <br>
