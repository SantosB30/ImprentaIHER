                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-md-5" id="data_5">
                            ...
                            <input type="text" class="form-control" id="direccionProveedor" name="direccionProveedor" required placeholder="Dirección"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Teléfono:</strong></label>
                            <input type="text" class="form-control" id="telefonoProveedor" name="telefonoProveedor" required placeholder="Teléfono"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                        ...
                        <div class="col-md-5" id="data_5">
                            ...
                            <input type="text" class="form-control" id="nombreContactoProveedor" name="nombreContactoProveedor" required placeholder="Nombre de contacto"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Teléfono contacto:</strong></label>
                            <input type="text" class="form-control" id="telefonoContactoProveedor" name="telefonoContactoProveedor" required placeholder="Teléfono de contacto"/>
                        </div>
                        <div class="col-md-5">
                            <br>
                            <br>
