...
@If Session("mensaje") <> Nothing Then
    If Session("mensaje").ToString().Equals("Proveedor eliminado") Then
        @<script>
...
<div Class="ibox float-e-margins">
    <div Class="ibox-title">
        <h3> <strong>Eliminar proveedores</strong></h3>
    ...
    <div Class="ibox-content">
        @Using Html.BeginForm("EliminarProveedor", "Proveedores", FormMethod.Post)
            @<div class="row">
                <div class="col-lg-12">
                    <div class="row">
