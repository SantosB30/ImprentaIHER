                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-5" id="data_5">
                            ...
                            <input type="text" class="form-control" id="nombreProveedor" name="nombreProveedor" required value="@Session("proveedorEditar")" placeholder="Nombre" onkeyup="this.value = this.value.toUpperCase().replace(/\s+$/, ' ');" oninvalid="this.setCustomValidity('Nombre completo del proveedor')" oninput="setCustomValidity('')"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <label class="font-normal"><strong>Dirección:</strong></label>
                            <input type="text" class="form-control" id="direccionProveedor" name="direccionProveedor" required value="@Session("direccionProveedor")" placeholder="Dirección" onkeyup="this.value = this.value.toUpperCase().replace(/\s+$/, ' ');" oninvalid="this.setCustomValidity('Dirección')" oninput="setCustomValidity('')"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Teléfono:</strong></label>
                            <input type="text" class="form-control" id="telefonoProveedor" name="telefonoProveedor" required value="@Session("telefonoProveedor")" placeholder="Teléfono" onkeyup="this.value = this.value.toUpperCase().replace(/\s+$/, '');" oninvalid="this.setCustomValidity('Número de telefono')" oninput="setCustomValidity('')"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Correo electrónico:</strong></label>
                            <input type="email" class="form-control" id="correoProveedor" name="correoProveedor" maxlength="50" required value="@Session("correoProveedor")" placeholder="Correo electrónico" onkeyup="this.value = this.value.toUpperCase().replace(/\s+$/, '');" />
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Nombre contacto:</strong></label>
                            <input type="text" class="form-control" id="nombreContactoProveedor" name="nombreContactoProveedor" required value="@Session("nombreContactoProveedor")" placeholder="Nombre de contacto" onkeyup="this.value = this.value.toUpperCase().replace(/\s+$/, ' ');" oninvalid="this.setCustomValidity('Nombre completo del contacto')" oninput="setCustomValidity('')"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Teléfono contacto:</strong></label>
                            <input type="text" class="form-control" id="telefonoContactoProveedor" name="telefonoContactoProveedor" required value="@Session("telefonoContactoProveedor")" placeholder="Teléfono de contacto" onkeyup="this.value = this.value.toUpperCase().replace(/\s+$/, '');" oninvalid="this.setCustomValidity('Número de telefono del contacto')" oninput="setCustomValidity('')"/>
                        </div>
