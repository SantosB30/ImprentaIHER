@Code
    ViewData("Title") = "Ver orden | Imprenta IHER"
    Layout = "~/Views/Shared/_Layout.vbhtml"
End Code

<div class="ibox float-e-margins">
    <div class="ibox-title">
        <h3> <strong>Ver orden</strong></h3>
        ...
        <div class="wrapper wrapper-content animated fadeIn">
            <div class="text-center pdf-toolbar">
                <div class="btn-group">
                    ...
                    @Using Html.BeginForm("VerOrdenProduccion", "OrdenesDeProduccion", FormMethod.Post)
...
@Section Scripts
    ...
    <script type="text/javascript">
        ...
        //
        var url = '@Session("archivoOrden").ToString()';
