...
@Code
    ViewData("Title") = "Reporte de inventario | Imprenta IHER"
    Layout = "~/Views/Shared/_Layout.vbhtml"
    @ModelType IEnumerable(Of ProyectoIHER.InventarioModel)
...
<div Class="ibox float-e-margins">
    ...
    <div Class="ibox-content">
        @Using Html.BeginForm("ReporteDeInventario", "OrdenesDeProduccion", FormMethod.Post)
            @<div class="row">
                <div class="col-lg-12">
                    <div class="row">
