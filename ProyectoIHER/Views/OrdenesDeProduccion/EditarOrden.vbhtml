                ...
                <div class="step-content">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input id="lugarEntrega" name="lugarEntrega" type="text" class="form-control required" onkeyup="this.value = this.value.toUpperCase();" value="@Session("lugar_entrega").ToString()">
                        </div>
                        <div class="col-lg-2">
                            <Label class="font-normal"><strong>Fecha de entrega:</strong></Label>
                            <input type="date" class="form-control" required id="fechaEntrega" name="fechaEntrega" value="@Session("fecha_entrega").ToString()" />
                        </div>
                        <div class="col-lg-2">
                            <Label class="font-normal"><strong>Cantidad:</strong></Label>
                            <input type="number" class="form-control" required value="@Session("cantidad").ToString()" min="0" id="cantidad" name="cantidad" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div class="col-lg-2">
                            <Label class="font-normal"><strong>Número de páginas:</strong></Label>
                            <input type="number" class="form-control" required value="@Session("numero_paginas").ToString()" min="0" id="numeroPaginas" name="numeroPaginas" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div class="col-lg-2">
                            <br>
                            ...
                            <select class="form-control" required id="orientacion" name="orientacion">
                                ...
                                @If Session("orientacion").ToString().Equals("VERTICAL") Then
                        ...
                        <div Class="col-lg-2">
                           ...
                           <Label Class="font-normal"><strong>Prioridad:</strong></Label>
                            <select Class="form-control" required id="prioridad" name="prioridad">
                                <option value = "" > ---SELECCIONE - --</option>
                                 @If Session("orientacion").ToString().Equals("URGENTE") Then
                        ...
                        <div Class="col-lg-2">
                            ...
                            <input type = "text" Class="form-control" required id="tamaño" name="tamaño" onkeyup="this.value = this.value.toUpperCase();"  value="@Session("tamaño").ToString()"/>
                        </div>
                    </div>
                </div>
                <h1> Material</h1>
                <div Class="step-content">
                    <div Class="row">
                        <div Class="col-lg-3">
                            ...
                            <input type = "text" Class="form-control" required  value="@Session("material_portada")" id="materialPortada" name="materialPortada" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-3">
                            <Label Class="font-normal"><strong>Gramaje:</strong></Label>
                            <input type = "number" Class="form-control" required  value="@Session("gramaje_portada")"id="gramajePortada" name="gramajePortada" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-3">
                            <Label Class="font-normal"><strong>Color:</strong></Label>
                            <input type = "text" Class="form-control" required  value="@Session("color_portada")" id="colorPortada" name="colorPortada" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-3">
                            <Label Class="font-normal"><strong>Tamaño:</strong></Label>
                            <input type = "text" Class="form-control" required  value="@Session("tamaño_portada")" id="tamañoPortada" name="tamañoPortada" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                    ...
                    <div Class="row">
                        <br>
                            ...
                            <input type = "text" Class="form-control" required  value="@Session("material_interior")" id="materialInterior" name="materialInterior" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-3">
                            <Label Class="font-normal"><strong>Gramaje:</strong></Label>
                            <input type = "number" Class="form-control" required  value="@Session("gramaje_interior")" id="gramajeInterior" name="gramajeInterior" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-3">
                            <Label Class="font-normal"><strong>Color:</strong></Label>
                            <input type = "text" Class="form-control" required  value="@Session("color_interior")" id="colorInterior" name="colorInterior" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-3">
                            <Label Class="font-normal"><strong>Tamaño:</strong></Label>
                            <input type = "text" Class="form-control" required  value="@Session("tamaño_interior")" id="tamañoInterior" name="tamañoInterior" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                    ...
                    <div Class="row">
                        <br>
                            ...
                            <input type = "text" Class="form-control" required  value="@Session("material_otro")" id="materialOtro" name="materialOtro" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-3">
                            <Label Class="font-normal"><strong>Gramaje:</strong></Label>
                            <input type = "number" Class="form-control" required  value="@Session("gramaje_otro")" id="gramajeOtro" name="gramajeOtro" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-3">
                            <Label Class="font-normal"><strong>Color:</strong></Label>
                            <input type = "text" Class="form-control" required  value="@Session("color_otro")" id="colorOtro" name="colorOtro" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-3">
                            <Label Class="font-normal"><strong>Tamaño:</strong></Label>
                            <input type = "text" Class="form-control" required  value="@Session("tamaño_otro")" id="tamañoOtro" name="tamañoOtro" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                    ...
                    <div Class="row">
                        ...
                        <div Class="col-lg-4">
                            <Label Class="font-normal"><strong>Portada:</strong></Label>
                            <input type = "number" Class="form-control" required  id="cantidadResmasPortada" name="cantidadResmasPortada" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-4">
                            <Label Class="font-normal"><strong>Interior:</strong></Label>
                            <input type = "number" Class="form-control" required  id="cantidadResmasInterior" name="cantidadResmasInterior" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                        <div Class="col-lg-4">
                            <Label Class="font-normal"><strong>Otro:</strong></Label>
                            <input type = "number" Class="form-control" required   id="cantidadResmasOtro" name="cantidadResmasOtro" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                    </div>
                </div>
                <h1> Color</h1>
                ...
                <div Class="step-content">
                    <div Class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <input class="form-control" type="number"  value="@Session("cantidad_imprimir").ToString()" required id="cantidadImprimir" name="cantidadImprimir" onkeyup="this.value = this.value.toUpperCase();" />
                        </div>
                    </div>
                </div>
                ...
                <div class="step-content">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <textarea class="form-control" type="text" id="observacionesEspecificas"  value="@Session("observaciones_especificias").ToString()" name="observacionesEspecificas" rows="3" required onkeyup="this.value = this.value.toUpperCase();"></textarea>
                        </div>
                    </div>
                </div>
            </div>
