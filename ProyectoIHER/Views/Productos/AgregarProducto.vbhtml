                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-5" id="data_5">
                            ...
                            <input type="text" class="form-control" id="nombreProducto" name="nombreProducto" required placeholder="Nombre"  onkeyup="this.value = this.value.toUpperCase();" oninvalid="this.setCustomValidity('Nombre del producto')" oninput="setCustomValidity('')"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <label class="font-normal"><strong>Descripción:</strong></label>
                            <input type="text" class="form-control" id="descripcionProducto" name="descripcionProducto" required placeholder="Descripción"  onkeyup="this.value = this.value.toUpperCase();" oninvalid="this.setCustomValidity('Descripción del producto')" oninput="setCustomValidity('')"/>
                        </div>
                        <div class="col-md-5" id="data_5">
                            <br>
                            <label class="font-normal"><strong>Precio:</strong></label>
                            <input type="number" step="0.01" class="form-control" id="precioProducto" name="precioProducto" required placeholder="Precio"  onkeyup="this.value = this.value.toUpperCase();" oninvalid="this.setCustomValidity('Precio del producto')" oninput="setCustomValidity('')"/>
                        </div>
                        <div class="col-md-5">
                            <br>
                            <br>
