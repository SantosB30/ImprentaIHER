...
Public Class ReporteDeBodega
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProyectoIHER.ReporteDeBodega.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteDeBodega
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteDeBodega = New ReporteDeBodega()
        rpt.Site = Me.Site
        Return rpt
    End Function
